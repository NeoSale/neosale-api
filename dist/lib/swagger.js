...
console.log('🔍 Routes path exists:', fs_1.default.existsSync(routesPath));
...
console.log('📚 Swagger spec paths:', exports.swaggerSpec.paths ? Object.keys(exports.swaggerSpec.paths) : 'No paths found');

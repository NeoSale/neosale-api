...
import { N8nChatHistoriesController } from '../controllers/n8nChatHistoriesController';
 ...
 */
router.post('/', validateRequest(createChatHistorySchema), N8nChatHistoriesController.createSimpleChatHistory);

/**
 * @swagger
 * /api/n8n_chat_histories/sendText:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
router.post('/sendText', validateRequest(createChatHistorySchema), N8nChatHistoriesController.createChatHistory);

/**
 * @swagger
 * /api/n8n_chat_histories/cliente:
 *   get:
 ...
 *         description: Erro interno do servidor
 */
router.get('/cliente', N8nChatHistoriesController.getChatHistoriesByClienteId);

/**
 * @swagger
 * /api/n8n_chat_histories/session/{session_id}:
 *   get:
 ...
 *         description: Erro interno do servidor
 */
router.get('/session/:session_id', N8nChatHistoriesController.getChatHistoriesBySessionId);

/**
 * @swagger
 * /api/n8n_chat_histories/{id}:
 *   get:
...
router.get('/:id', (req, res, next) => {
  ...
  next();
}, validateRequest(numericIdParamSchema, 'params'), N8nChatHistoriesController.getChatHistoryById);
 ...
 *         description: Erro interno do servidor
 */
router.put('/:id', validateRequest(numericIdParamSchema, 'params'), validateRequest(updateChatHistorySchema), N8nChatHistoriesController.updateChatHistory);
 ...
 *         description: Erro interno do servidor
 */
router.delete('/:id', validateRequest(numericIdParamSchema, 'params'), N8nChatHistoriesController.deleteChatHistory);

/**
 * @swagger
 * /api/n8n_chat_histories/ultima_mensagem/{session_id}:
 *   get:
 ...
 *         description: Erro interno do servidor
 */
router.get('/ultima_mensagem/:session_id', N8nChatHistoriesController.getMessagesBySessionIDType);
 ...
 *         description: Erro interno do servidor
 */
router.delete('/session/:session_id', N8nChatHistoriesController.deleteChatHistoriesBySessionId);

/**
 * @swagger
 * /api/n8n_chat_histories/{session_id}/mark-error:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
router.post('/:session_id/mark-error', validateRequest(sessionIdParamSchema, 'params'), N8nChatHistoriesController.markLastMessageAsError);
